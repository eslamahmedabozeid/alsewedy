...
describe('TaskListComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [TaskListComponent,TaskComponentComponent],
    });
  ...
  it('should display tasks with pagination', () => {
    const mockTasks =[{id: 1,title: 'Main Data Ethiopia',suk: '#TSK_216894891',status: 'Running',color: '#0090ff',date: '2023-09-19', time:'15:55:17',image: './assets/loop.png',
    selection : [
  ...
  // Add more tests as needed for the TaskListComponent
});
